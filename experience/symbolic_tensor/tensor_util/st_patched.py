...
if __name__ == "__main__":
    ...
    # Test 1: Basic - patched returns new tensor, original unchanged
    ...
    # Test 2: Empty diff - returns copy
    ...
    # Test 5: Roundtrip with patch_tensor equivalence
